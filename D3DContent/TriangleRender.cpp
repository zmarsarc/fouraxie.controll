...
//  CTriangleRender
//
//      Subclass of CRender that renders a single, spinning triangle
//
//------------------------------------------------------------------------------
...
//
//  Member:
//      CTriangleRender ctor
//
//------------------------------------------------------------------------------
CTriangleRender::CTriangleRender() : CRender(), m_pd3dVB(NULL)
{
}
...
//
//  Member:
//      CTriangleRender dtor
//
//------------------------------------------------------------------------------
CTriangleRender::~CTriangleRender()
{
...
//------------------------------------------------------------------------------
HRESULT
CTriangleRender::Create(IDirect3D9 *pD3D, IDirect3D9Ex *pD3DEx, HWND hwnd, UINT uAdapter, CRender **ppRenderer)
{
	HRESULT hr = S_OK;

	CTriangleRender *pRenderer = new CTriangleRender();
	IFCOOM(pRenderer);
...
//
//  Member:
//      CTriangleRender::Init
//
//  Synopsis:
//      Override of CRender::Init that calls base to create the device and 
//      then creates the CTriangleRender-specific resources
//
//------------------------------------------------------------------------------
HRESULT
CTriangleRender::Init(IDirect3D9 *pD3D, IDirect3D9Ex *pD3DEx, HWND hwnd, UINT uAdapter)
{
	HRESULT hr = S_OK;
	...
	IFC(CRender::Init(pD3D, pD3DEx, hwnd, uAdapter));
